...
export const Head: HeadFC = () => (
  <>
    ...
    <meta
      name="description"
      content="I compose a lot of musics inspired by cultural references but also driven by my own emotions. Here are a some title inspired by chamber orchestra"
    />
  </>
);
